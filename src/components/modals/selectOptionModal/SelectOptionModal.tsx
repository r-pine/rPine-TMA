					...
					<div className={styles.modalContent} onClick={e => e.stopPropagation()}>
						...
						>
							<div className={styles.modalHeader}>
								<h2 className={styles.modalTitle}>{t('select_action')}</h2>
								<button
							...
							<div className={styles.modalBody}>
								<div className={styles.optionsContainer}>
									<div className={styles.selectionWrapper}>
										<h3 className={styles.optionHeader}>Airswap</h3>
										<p className={styles.optionParagraph}>{t('airswap_description')}</p>
										<motion.button
											className={styles.optionButton}
											onClick={() => handleOptionClick('/airswap')}
									...
									<div className={styles.selectionWrapper}>
										<h3 className={styles.optionHeader}>Airdrop</h3>
										<p className={styles.optionParagraph}>{t('airdrop_description')}</p>
										<motion.button
											className={styles.optionButton}
											onClick={() => handleOptionClick('/airdrop')}
											whileHover={{ scale: 1.02 }}
											whileTap={{ scale: 0.95 }}
										>
