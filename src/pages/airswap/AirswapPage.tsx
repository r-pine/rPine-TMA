...
import { fetchAirswapTransactionData } from '../../entities/airswap/api/airswap.api';
		...
		<div className={styles.modalOverlay} onClick={handleClose}>
			<div className={styles.modalContent} onClick={e => e.stopPropagation()}>
				<div className={styles.modalHeader}>
					<h2 className={styles.modalTitle}>Airswap</h2>
					<button
				...
				<div className={styles.modalBody}>
					<div className={styles.optionsContainer}>
						<div className={styles.selectionWrapper}>
							<h3 className={styles.optionHeader}>{t('exchange_aPine_header')}:</h3>
							<p className={styles.optionParagraph}>{t('o_Pine_amount')}:</p>
							<div className={styles.amountPineBox}>
								{isConnected ? (
									opineBalance ? `${opineBalance} oPine` : '0 oPine'
								) : (
